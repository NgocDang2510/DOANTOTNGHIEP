...
import com.saf.core.repositories.FavoriteRepository;
...
public class FavoriteController {
    ...
    /** Toggle yêu thích — trả về trạng thái mới */
    @PostMapping("/{roomId}")
    ...
    /** Lấy danh sách phòng đã lưu của user hiện tại */
    @GetMapping
    ...
    public ResponseEntity<ApiResponse<?>> getBatchStatus(@RequestBody List<Long> roomIds) {
        ...
        Map<Long, Boolean> result = roomIds.stream()
